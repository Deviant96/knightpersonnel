   ...
   'items':[ {
	   ...
	   'quantity':'1',
	    'transaction_id':  myArray[0]
			 ...
			 window.uetq = window.uetq || []; window.uetq.push('event', 'PRODUCT_PURCHASE', {"ecomm_prodid": myArray[0],"ecomm_pagetype":"PURCHASE","revenue_value":price,"currency":"AUD"});
...
})(window,document,'script','dataLayer','GTM-TLMZBPJ');</script>
<!-- End Google Tag Manager -->
<!-- Facebook Pixel Code --><script>!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version=\'2.0\';n.queue=[];t=b.createElement(e);t.async=!0;t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window, document,\'script\',\'https://connect.facebook.net/en_US/fbevents.js\');fbq(\'init\', \'1152333235562390\');fbq(\'track\', \'PageView\');</script><noscript><img height=\"1\" width=\"1\" style=\"display:none\"src=\https://www.facebook.com/tr?id=1152333235562390&ev=PageView&noscript=1\/></noscript><!-- End Facebook Pixel Code -->
...
function add_to_cart_ajax() {
   $click_num = intval($_POST['click_num']);
	...
	array_push($StorePurchaseCourse,$purchaseCourseTitle);
     ...
     WC()->cart->add_to_cart( 1074, 1, 0, array(),  array('misha_custom_price' => $misha_custom_price,
...
function updatePayment($person_id,$enrolment_id, $payment_plan_id, $payment_received, $course_id, $plan_id, $start_date , $end_date){
	...
	$apiResult = get_rtodata(array(	'type' => 'payment',
									'person_id' => $person_id,
